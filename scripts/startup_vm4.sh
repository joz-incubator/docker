...
docker network create -d ipvlan   --subnet=192.168.400.0/24   --gateway=192.168.400.1   -o parent=$PARENT_IF ipvlan-net

# Run container with static IP
docker run -d --net=ipvlan-net --ip=192.168.400.10 nginx
