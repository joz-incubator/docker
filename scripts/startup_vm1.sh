...
ip addr add 192.168.100.1/24 dev ipvlan 
ip link set ipvlan up

# Create ipvlan network
docker network create -d ipvlan --subnet=192.168.100.0/24 --gateway=192.168.100.1  -o ipvlan_mode=l3 -o parent=$PARENT_IF ipvlan-net
